...
begin
  ...
  begin
    MensagemDeInformacao('Este recurso não está disponível para Representantes.'+PL+'Somente Fornecedores.');
    Exit;
  end;
...
begin
  ...
  MensagemDeInformacao('Ok.'+PL+'Informações salvas em:'+PL+Arq);
end;
...
begin
  ...
  AbreAviso('Desfazendo operações');
  Book := CDS.GetBookmark;
  Screen.Cursor := crHourGlass;
  try
