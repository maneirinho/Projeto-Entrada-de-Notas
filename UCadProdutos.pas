...
begin
  ...
  begin
    ...
    if JaTem then
    begin
      MensagemDeAtencao(lbCodigo2.Caption+' '+edCodigo2.Text+' já cadastrado no item'+PL+S);
      begin
        result := true;
        PageControl1.ActivePage := TabSheet1;
        edCodigo2.SetFocus;
  ...
  begin
    ...
    if JaTem then
    begin
      MensagemDeAtencao(lbCodigo3.Caption+' '+edCodigo3.Text+' já cadastrado no item'+PL+S);
      begin
        result := true;
        PageControl1.ActivePage := TabSheet1;
        edCodigo3.SetFocus;
  ...
  begin
    ...
    if JaTem then
    begin
      MensagemDeAtencao(lbCodigo4.Caption+' '+edCodigo4.Text+' já cadastrado no item'+PL+S);
      begin
        result := true;
        PageControl1.ActivePage := TabSheet1;
        edCodigo4.SetFocus;
  ...
  begin
    ...
    if JaTem then
    begin
      MensagemDeAtencao('Código de Balança'+' '+edCodBalanca.Text+' já cadastrado no item'+PL+S);
      begin
        result := true;
        PageControl1.ActivePage := TabSheet1;
...
begin
  ...
  begin
    if MensagemDeConfirmacao('Deseja também alterar as informações para produtos similares?') = mrYes then
      AtualizaSimilares;
  end;
  ...
  with CM do begin
    ...
    try
      ...
      on E: exception do begin
        ...
        MensagemDeErro('Não foi possível atualizar informações para produtos similares...');
  ...
  begin
    ...
    try
      ...
      on E: exception do begin
        LogDeErros(E.Message);
        IBTabela.IB_Transaction.Rollback;
        MensagemDeErro('Não foi possível atualizar a média de venda.');
      end;
    end;
