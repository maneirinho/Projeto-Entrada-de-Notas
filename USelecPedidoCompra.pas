...
uses
  ...
  UComp, DB, UComum, DBIboSuperCombo, MessageFunctions;
...
uses UDadosProduto, DBFunctions, UCadProdutos, UConstVar;
...
begin
  ...
  begin
    ...
    begin
      MensagemDeErro('Não há Pedidos Fechados para este Fornecedor');
      Close;
      Exit;
    end;
    ...
    with DtM do begin
      ...
      try
        ...
        on E: exception do begin
          ...
          MensagemDeErro('Não foi possível baixar o Pedido de Compra');
        end;
      end;
    end;
    Close;
    ...
    with DtM do begin
      ...
      try
        ...
        on E: exception do begin
          LogDeErros(E.Message);
          IBTabela.IB_Transaction.Rollback;
          MensagemDeErro('Não foi possível alterar este item do pedido');
        end;
      end;
      IBPCItems.Refresh;
    end;
