...
begin
  ...
  try
    AbreAviso('Carregando informações');
...
begin
  ...
  begin
    MessageDlg('A conexão com o Banco de Dados foi perdida.'+PL+
               'Pressione OK para tentar reestabelecer a conexão.', mtError, [mbOK], 0);
