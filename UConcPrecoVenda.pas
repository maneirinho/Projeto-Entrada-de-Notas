...
begin
  if MensagemDeConfirmacao('Deseja atualizar preços de Venda agora?') = mrYes then
  begin
    AbreAviso('Conciliando preços de Venda...', 0, 0, 0, 0);
    with DtM do
    begin
    ...
    MensagemDeInformacao('Ok.'+PL+'Conciliação concluída.'+PL+IntToStr(QuantidadeAlterada)+' produtos foram afetados.');
    btFechar.SetFocus;
  end;
end;
