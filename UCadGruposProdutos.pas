...
begin
  try
    ...
    begin
      ...
      begin
        MensagemDeAtencao('Não é possível cadastrar este GRUPO.'+PL+'Já existe um GRUPO com a Descrição "'+fEditaGrupoProduto.Edit1.Text+'" neste mesmo nível.');
        Exit;
      end;
      ...
      try
        ...
        MensagemDeErro('Não foi possível inserir este grupo');
...
begin
  try
    ...
    begin
      ...
      if EstaTabela.FieldByName('Q').AsInteger > 0 then
      begin
        MensagemDeAtencao('Não é possível renomear este GRUPO.'+PL+'Já existe um GRUPO com a Descrição "'+fEditaGrupoProduto.Edit1.Text+'" neste mesmo nível.');
        Exit;
      end;
      ...
      try
        ...
        MensagemDeErro('Não foi possível alterar este grupo');
        EstaTabela.IB_Transaction.Rollback;
      end;
    end;
  finally
...
begin
  try
    ...
    begin
      MensagemDeAtencao('Não é possível excluir um GRUPO que tenha SUBGRUPO(S).'+PL+
    ...
    begin
      ...
      try
        ...
        MensagemDeErro('Não foi possível excluir este grupo');
        EstaTabela.IB_Transaction.Rollback;
      end;
    end;
  finally
