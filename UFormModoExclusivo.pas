...
begin
  case ModoModoExclusivo of
    ...
    begin
      ...
      lbLinha1.Caption  := 'O Sistema está ocupado com Processamento Exclusivo';
      lbLinha2.Caption  := 'para o Computador com Endereço IP Final';
    ...
    mmDesbloquear:
    begin
      lbAguarde.Caption := 'Atenção!';
      lbLinha1.Caption  := 'O Sistema está sendo executado em Modo Exclusivo para este Computador.';
      lbLinha2.Caption  := 'Nenhum outro terminal da rede poderá ter acesso ao Sistema';
      lbLinha3.Caption  := 'até que este Computador Desbloqueie este acesso';
