...
begin
  ...
  begin
    result := true;
    MensagemDeAtencao('É necessário informar um Produto');
  ...
  begin
    result := true;
    MensagemDeAtencao('É necessário informar um Código para a GRADE');
    edCdGrade.SetFocus;
    Exit;
  end;
  ...
  begin
    result := true;
    MensagemDeAtencao('É necessário informar uma Descrição para a GRADE');
    edNmGrade.SetFocus;
    Exit;
  end;
  ...
  begin
    ...
    begin
      result := true;
      MensagemDeAtencao('É necessário informar um NOVO Código para o PRODUTO');
    ...
    begin
      result := true;
      MensagemDeAtencao('O "Código do PRODUTO" e o "Código da GRADE" NÃO podem ser IGUAIS');
      edCodNovoProduto.SetFocus;
      Exit;
    end;
  end
  ...
  begin
    result := true;
    MensagemDeErro('Código já cadastrado no campo "Código da GRADE"');
    edCdGrade.SetFocus;
  end;
  ...
  begin
    ...
    begin
      result := true;
      MensagemDeErro('Código já cadastrado no campo "Novo Código do PRODUTO"');
      edCodNovoProduto.SetFocus;
    end;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          LabelAviso('Alterando Código do Produto');
        ...
        begin
          ...
          LabelAviso('Alterando a Descrição do Produto');
          EstaTabela.Active := false;
          EstaTabela.SQL.Clear;
      ...
      MensagemDeErro('Não foi possível transformar este PRODUTO em uma GRADE');
    end;
  finally
